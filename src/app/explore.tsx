    ...
    <ScreenShell>
      <View style={styles.hero}>
        ...
        <ThemedText type="subtitle" style={styles.subtitle}>
          Review your modules, practice quickly, and experiment with AI prompts in one place.
        </ThemedText>
      </View>
      ...
      <ThemedView type="backgroundElement" style={styles.introCard}>
        ...
        <ThemedText type="default" style={styles.cardText}>
          Each module has a mastery score that improves when you practice. The app tracks progress across your learning path.
        </ThemedText>
      </ThemedView>
