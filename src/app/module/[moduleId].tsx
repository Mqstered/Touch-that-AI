...
export default function ModuleDetailScreen() {
  ...
  const { moduleId } = useSearchParams();
  ...
  return (
    <ScreenShell>
      ...
      <ThemedView type="backgroundElement" style={styles.card}>
        ...
        <ThemedText type="default" style={styles.bodyText}>
          {module.focus} Use the button below to mark a short review session complete and improve your mastery score.
        </ThemedText>
        <PrimaryButton title="Review this module" onPress={() => practiceModule(module.id)} />
      </ThemedView>
